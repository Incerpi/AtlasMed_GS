...
namespace AtlasMed_GS.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPaciente,Nome,Cpf,DataNascimento,Email,Telefone,Rua,Numero,Bairro,Cidade,Estado,Cep")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPaciente,Nome,Cpf,DataNascimento,Email,Telefone,Rua,Numero,Bairro,Cidade,Estado,Cep")] Paciente paciente)
        {
